...
levels(pData(dat.filtered)$cluster)[levels(pData(dat.filtered)$cluster)==9] <- 7
levels(pData(dat.filtered)$cluster)[levels(pData(dat.filtered)$cluster)==5] <- 3
levels(pData(dat.filtered)$cluster)[levels(pData(dat.filtered)$cluster)==6] <- 1

levels(pData(dat.filtered)$cluster)[levels(pData(dat.filtered)$cluster)==7] <- 5
levels(pData(dat.filtered)$cluster)[levels(pData(dat.filtered)$cluster)==8] <- 6
levels(pData(dat.filtered)$cluster)[levels(pData(dat.filtered)$cluster)==10] <- 7
levels(pData(dat.filtered)$cluster)[levels(pData(dat.filtered)$cluster)==11] <- 8
