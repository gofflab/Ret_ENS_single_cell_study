...
write.csv(ego_genotype@result, "DEG_all_cells_genotype_GO.csv")

ego_genotype_subset <- ego_genotype@result[c(3,4,6,7,8,10,17,22,23, 30, 34, 39, 41, 43, 44, 46, 48, 52, 56, 57, 58, 65, 66, 78, 95, 99, 101, 103, 104, 106, 107, 113, 119, 128, 148, 159, 162, 177, 179, 180, 182, 183, 191, 194, 195, 203, 210, 223, 224, 225, 232, 245, 254, 255, 258, 262, 264, 265, 266, 267, 268, 269, 278, 281, 282, 285, 297, 299, 300, 302, 308, 312, 320, 334, 346, 353, 354, 355, 369, 370, 378, 382, 385, 388, 399, 419, 422, 423, 428, 440, 441, 464, 471, 482, 483, 488, 494, 497, 516, 519, 534, 569, 578, 596, 598, 608, 617, 622, 626, 636, 692, 710, 712, 717, 719, 720, 727, 744, 756, 757, 768, 769, 776, 784, 787, 793, 794),]

ego_genotype_subset <- ego_genotype_subset[!ego_genotype_subset$ID %in% c("GO:0009713", "GO:0042423", "GO:0009712", "GO:0042416", "GO:0007272", "GO:008366", "GO:0007096", "GO:0055057", "GO:0046879", "GO:0014009", "GO:0051961", "GO:0007411", "GO:0050433", "GO:0050432", "GO:0014032", "GO:0042415", "GO:0008344", "GO:0014014", "GO:0014015", "GO:0030852"),]
```
...
write.csv(ego_genotype_sex@result, "DEG_all_cells_genotypeXsex_GO.csv")
```
...
write.csv(ego_genotype_celltype@result, "DEG_all_cells_genotypeXcelltype_GO.csv")
```
...
write.csv(ego_bifurcation@result, "DEG_clusters7&8_cluster_GO.csv")
```
...
write.csv(ego_Ret_independent@result, "DEG_cluster8_genotype_GO.csv")
```
...
write.csv(ego_glia_genotype@result, "DEG_glia!cluster9_genotype_GO.csv")
```
